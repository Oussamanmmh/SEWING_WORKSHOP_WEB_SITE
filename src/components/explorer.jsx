const Explorer = () => {
    return (
        <div
  class="group relative flex justify-center items-center text-zinc-600 text-sm font-bold ml-20 mr-20"
>
  <div
  ...
  >
    <div class="bg-lime-200 flex items-center gap-1 p-2 rounded-md">
      ...
      <a href="https://www.facebook.com/profile.php?id=100064107037202&sk=photos" className="cursor-pointer">Works by Khawla</a>
    </div>
    <div
  ...
  >
    ...
    >
      ...
      ></path></svg><span class="text-[0px] group-hover:text-sm duration-300"
      >Visiter notre page</span >
  </div>
</div>
    );
    }
