const CardesReseaux = () => {
    return(
        <section className="mt-10 flex flex-row md:justify-around gap-5  md:gap-20 ">
        <div class="card md:w-full shadow-2xl shadow-black-100">
    <div class="icon">
    ...
    <span><a href="https://www.instagram.com/wroks_by.khawla/">Abonnez-vous</a></span>
</div>
<div class="card md:w-full shadow-2xl shadow-black-100">
    <div class="icon">
    <svg
    ...
    <span><a  href="Abonnez-vous" >Abonnez-vous</a></span>
</div>
</section>
    )
}
export default CardesReseaux;